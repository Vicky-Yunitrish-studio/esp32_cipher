...
//                     char tempStr[8];
//                     char humStr[8];
//                     dtostrf(temp, 4, 1, tempStr);  // 格式化溫度到一位小數
//                     dtostrf(hum, 4, 1, humStr);    // 格式化濕度到一位小數
//                     mqtt.publish(storage.getMqttTempTopic().c_str(), tempStr);
//                     mqtt.publish(storage.getMqttHumTopic().c_str(), humStr);
